...
»Ich verspreche es.«`,
    ...
    choices: [{ text: "→ Das Archiv", next: "a6k4_archiv" }],
...
Als hätte er zum ersten Mal verstanden, dass Aufgeben manchmal nur eine andere Form von Wahrheit ist.`,
    ...
    choices: [{ text: "→ Der Kern-Garten", next: "a6k6_kern" }]
  },
...
»Du musst ihm beibringen, dass Wahl kein Tod ist.«`,
    ...
    choices: [{ text: "→ Schreiben", next: "a6k7_finale" }],
...
Und wem darf sie gehören?`,
    ...
    choices: [
      ...
      },
      {
        ...
        requires: { flag: { opferRichtigeAntwort: true } },
        next: "ending_7",
      ...
      },
      {
        ...
        requires: { alignment: { schatten: 10 } },
        next: "ending_5",
...
Aber spürbar.`,
    ...
    choices: [{ text: "→ Hauptmenü", next: "__title__" }]
  },
