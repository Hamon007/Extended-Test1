...
Das reichte.`,
    ...
    choices: [{ text: "→ Aetheria Prime", next: "a3k1_ankunft_akademie" }]
  },
...
Seras waren selten. Aber wenn sie kamen, war jeder Satz wie ein Nagel: knapp, präzise, dauerhaft.`,
    ...
    choices: [{ text: "→ Marcus Hale", next: "a3k2_marcus" }],
...
Yuki Nakamura — verloren. Ihre Magie unkontrolliert. Zu viel Kraft, zu wenig Welt.

Wie Sera am Fluss.

Die Wiederholung traf mich stärker, als ich zugeben wollte.`,

    choices: [{ text: "→ Die Heldenpartei formiert sich", next: "a3k4_helden_kontakt" }],
...
Sera schmilzt Tunnel.`,
    ...
    choices: [{ text: "→ Flucht und Exil", next: "a3k8_exil_vorbereitung" }],
...
Zum ersten Mal seit meiner Geburt in dieser Welt gab ich mir selbst einen Namen.`,
    ...
    choices: [{ text: "→ Kapitel 20: Reboot()", next: "a3k10_reboot" }]
  },
...
Zwischen dem, was das System glaubte, und dem, was wirklich war.`,
    ...
    choices: [{ text: "→ AKT IV: ELEVATION", next: "a4k1_intro" }],
