...
Zum ersten Mal seit langer Zeit friedlich.`,
    ...
    choices: [{ text: "→ Die ersten Monate", next: "a2_familie_montage" }],
...
Wer zum Teufel war dieser Mann?`,
    ...
    choices: [{ text: "→ Der Lachende Riese", next: "a2_lachender_riese" }],
...
Und das war wahrscheinlich das Gefährlichste, was mir in dieser Welt passieren konnte.`,
    ...
    choices: [{ text: "→ Kapitel 3: System.Scan()", next: "a3_code_read" }],
...
Das änderte alles.`,
    ...
    choices: [{ text: "→ Die Familie im Code", next: "a3_familie_scan" }],
...
Nah genug.`,
    ...
    choices: [
      ...
      {
        text: "C) BESCHLUSS — Kein Wort. Nur ein Name in deinem Kopf: Vex.",
        desc: "Feinddefinition vor Sprachreife.",
        next: "a4_mira_geburt",
...
Sie war Versicherung.`,
    ...
    choices: [{ text: "→ Das Gespräch in der Nacht", next: "a5_nachtgespraech" }]
  },
...
Damit niemand in diesem Haus noch einmal so dalag, weil wir uns Schmerzfreiheit nicht leisten konnten.`,
    ...
    choices: [{ text: "→ Einige Wochen später", next: "a6_goblin_encounter" }],
...
Und sprang.`,
    ...
    choices: [{ text: "→ 5 Sekunden", next: "a6_goblin_entscheidung" }]
  },
...
»...Hier.«`,
    ...
    choices: [{ text: "→ Danach", next: "a6_nachgespraech" }],
...
»Okay«, wiederholte er.`,
    ...
    choices: [{ text: "→ Gregors Archiv", next: "a6_gregor_archiv" }],
