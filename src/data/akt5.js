...
Und plötzlich waren selbst 100 eine kleine Zahl.`,
    ...
    choices: [{ text: "→ Operation Reinigung", next: "a5k1_kriegsplan" }]
  },
...
Das ist Mathematik.«`,
    ...
    choices: [{ text: "→ Yukis Timer", next: "a5k4_yuki" }],
...
Das war genug Wahrheit für einen Abend.`,
    ...
    choices: [{ text: "→ Celeste", next: "a5k5_celeste" }],
...
»Leicht.«`,
    ...
    choices: [{ text: "→ Martin Ashvale", next: "a5k8_prophet" }],
...
Das war bei ihr fast schon ein Kuss.`,
    ...
    choices: [{ text: "→ Der Aufbruch", next: "a5k10_aufbruch" }]
  },
...
ich bin bereit.«`,
    ...
    choices: [{ text: "→ AKT VI: System.Exit()", next: "a6k1_intro" }]
  },
};