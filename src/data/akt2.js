...
Freundschaft.`,
    ...
    choices: [{ text: "→ Gregors Geschichten", next: "a2k1_gregor_geschichten" }]
  },
...
Ich werde sie beschützen.`,
    ...
    choices: [{ text: "→ Kapitel 8: Kriegsrat", next: "a2k4_kriegsrat" }],
...
Also wahrscheinlich die richtige.`,
    ...
    choices: [{ text: "→ Die Inquisitoren kommen", next: "a2k4_inquisitor" }],
...
Ich rannte.`,
    ...
    choices: [{ text: "→ Der entscheidende Moment", next: "a2k5_rettung" }]
  },
...
Das würde Folgen haben.`,
    ...
    choices: [{ text: "→ Der Morgen danach", next: "a2k5_nachwirkungen" }]
  },
...
Ob der Schlag von Vex ihn schneller gebrochen hatte oder ob der Winter und das Alter es ohnehin bald getan hätten, war am Ende nicht wichtig. Wichtig war nur: Er wusste es.
...
Und morgen würden wir Millheim verlassen.`,
    ...
    choices: [{ text: "→ Abschied von Boris", next: "a2k6_boris_abschied" }],
...
Und damit die Vorbereitung auf den nächsten Käfig.`,
    ...
    choices: [{ text: "→ AKT III: Drei Jahre in Kreuzweg", next: "a3k0_zeitsprung" }]
  },
};