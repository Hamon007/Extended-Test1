...
Und ich war gut darin.`,
    ...
    choices: [{ text: "→ Kapitel 21: Irondeep", next: "a4k1_irondeep" }],
...
»Du bist laut, für jemanden, der gerade stirbt.«`,
    ...
    choices: [{ text: "→ Wer spricht da?", next: "a4k2_ren" }],
...
»Danke.«`,
    ...
    choices: [{ text: "→ Zurück an die Oberfläche", next: "a4k3_gorrick" }],
  },
...
Die erste von vielen.`,
    ...
    choices: [{ text: "→ Kapitel 26: Aria Moonsong", next: "a4k6_aria" }],
...
»EHRLICHKEIT GENÜGT FÜR JETZT. ABER NICHT FÜR IMMER.«`,
    ...
    choices: [{ text: "→ Rückzug mit Zugang", next: "a4k8_fortschritt" }]
  },
...
Aus Priorisierung.`,
    ...
    choices: [{ text: "→ Kapitel 29: Die Puristen", next: "a4k9_puristen" }]
  },
...
»Und diesmal vergessen WIR sie nicht.«`,
    ...
    choices: [{ text: "→ Kapitel 30: Vor der Brücke", next: "a4k9_finn_vorbruecke" }]
  },
...
Ungebrochen.`,
    ...
    choices: [{ text: "→ AKT V: Overflow", next: "a5k1_intro" }],
